...
Click "Next" on the next screens. On the project SDK screen select Java 17 (or newer) and click "Create".
**N.B.** For anyone on a Mac with a homebrew-installed openjdk, you need to use the directory under _libexec_: `<openjdk_directory>/libexec/openjdk.jdk/Contents/Home`.
