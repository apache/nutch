...
public class Train {
	...
	public static void start(String filepath) throws IOException{
		...
		//calculate the total number of instances/examples per class, word count in each class and for each class a word:frequency map
	    ...
	    FileSystem fs = FileSystem.get(configuration);
            ...
            BufferedReader bufferedReader = 
                new BufferedReader(configuration.getConfResourceAsReader(filepath));
