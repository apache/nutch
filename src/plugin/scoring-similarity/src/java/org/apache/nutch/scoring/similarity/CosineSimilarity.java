...
public class CosineSimilarity {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(cs.calculateCosineSimilarity("Classifieds listings of \nAll Categories in United States", "FREE Gun Classifieds - buy guns and sell guns online for FREE!"));
  }
}
