...
public class TestIndexReplace {
  ...
  public NutchDocument parseAndFilterFile(String fileName, Configuration conf) {
    ...
    Assertions.assertNotNull(basicIndexer);
    ...
    Assertions.assertNotNull(replaceIndexer);
  ...
  public void testPropertyParse() {
    ...
    try {
      ...
      Assertions.fail("Unable to parse a valid index.replace.regexp property! "
          + ohno.getMessage());
    }
    ...
    Assertions.assertEquals(indexReplaceProperty,
  ...
  public void testReplacementsDifferentTarget() {
    ...
    Assertions.assertEquals(expectedTargetDescription,
